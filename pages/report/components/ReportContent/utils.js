...
export const getTableData= ( report ) => {
  ...
  if(diagData) {
    ...
    res.imt = {
      ...
      isLeftAbnormal: left?.imt >= 1.0,
      isRightAbnormal: right?.imt >= 1.0,
    }
    res.imt_position = {
    ...
    res.patch_position = {
      ...
      isLeftAbnormal: !!left?.patch_position,
      isRightAbnormal: !!right?.patch_position
    }
    res.patch_count = {
      ...
      isLeftAbnormal: !!left?.patch_count,
      isRightAbnormal: !!right?.patch_count
    }
    res.patch_size_long = {
      left: left?.has_patch === 2 ? '--' : `${left?.patch_size_long}mm`,
      right: right?.has_patch === 2 ? '--' : `${right?.patch_size_long}mm`,
      isLeftAbnormal: !!left?.patch_size_long,
      isRightAbnormal: !!right?.patch_size_long
    }
    res.patch_size_thick = {
      left: left?.has_patch === 2 ? '--' : `${left?.patch_size_thick}mm`,
      right: right?.has_patch === 2 ? '--' : `${right?.patch_size_thick}mm`,
      isLeftAbnormal: !!left?.patch_size_thick,
      isRightAbnormal: !!right?.patch_size_thick
    }
    res.low_echo_count = {
      ...
      isLeftAbnormal: [2, 3].includes(left?.low_echo_count),
      isRightAbnormal: [2, 3].includes(right?.low_echo_count),
    }
    res.strong_echo_count = {
      ...
      isLeftAbnormal: [2, 3].includes(left?.strong_echo_count),
      isRightAbnormal: [2, 3].includes(right?.strong_echo_count),
    }
    res.mixed_echo_count = {
      ...
      isLeftAbnormal: [2, 3].includes(left?.mixed_echo_count),
      isRightAbnormal: [2, 3].includes(right?.mixed_echo_count),
    }
    res.stenosis_position = {
      ...
      isLeftAbnormal: !!left?.stenosis_position,
      isRightAbnormal: !!right?.stenosis_position
    }
    res.stenosis_percent = {
      ...
      isLeftAbnormal: [2, 3].includes(left?.stenosis_percent),
      isRightAbnormal: [2, 3].includes(right?.stenosis_percent)
    }
  }
